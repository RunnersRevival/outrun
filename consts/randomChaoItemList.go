...
var RandomChaoWheelChaoPrizes = map[string]float64{
	...
	enums.ChaoIDStrLightChaos: 1.46, // Permanent Pool
	enums.ChaoIDStrHeroChaos:  1.46, // Permanent Pool
	enums.ChaoIDStrDarkChaos:  1.46, // Permanent Pool
	enums.ChaoIDStrChip:       1.46, // Permanent Pool
	// enums.ChaoIDStrShahra:               4.0, // Runners' League Story Mode
	enums.ChaoIDStrCaliburn:         1.46, // Permanent Pool
	enums.ChaoIDStrKingArthursGhost: 1.46, // Permanent Pool
