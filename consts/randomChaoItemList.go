...
var RandomChaoWheelChaoPrizes = map[string]float64{
	...
	enums.ChaoIDStrRCSpring:             2.78, // Permanent Pool
	enums.ChaoIDStrRCElectromagnet:      2.78, // Permanent Pool
	enums.ChaoIDStrBabyCyanWisp:         2.78, // Permanent Pool
	enums.ChaoIDStrBabyIndigoWisp:       2.78, // Permanent Pool
	enums.ChaoIDStrBabyYellowWisp:       2.78, // Permanent Pool
	enums.ChaoIDStrRCPinwheel:           2.78, // Group 1
	enums.ChaoIDStrRCPiggyBank:          2.78, // Permanent Pool
