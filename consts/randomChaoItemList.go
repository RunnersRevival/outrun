...
var RandomChaoWheelCharacterPrizes = map[string]float64{
	...
	enums.CTStrSonic:    1.0, // Initial character - all groups
	enums.CTStrTails:    1.0, // Obtained in story mode - all groups
	enums.CTStrKnuckles: 1.0, // Obtained in story mode - all groups
	enums.CTStrAmy:      1.0, // Group 2
	enums.CTStrBig:      1.0, // Group 2
	// enums.CTStrBlaze:           0.81, // Group 3
	// enums.CTStrCharmy: 0.81, // Group 1
	enums.CTStrCream:  1.0, // Group 2
	// enums.CTStrEspio:  0.81, // Group 1
	enums.CTStrMephiles:        1.0, // Group 2
	// enums.CTStrOmega: 0.81, // Group 1
	enums.CTStrPSISilver:       1.0, // Group 2
	...
	enums.CTStrClassicSonic: 1.0, // Group 2
	// enums.CTStrMetalSonic:      0.81, // Group 1
	enums.CTStrSilver:      1.0, // Group 2
...
var RandomChaoWheelChaoPrizes = map[string]float64{
	...
	// enums.ChaoIDStrDarkChao:             2.78, // Event (Animal Rescue event 1.0) - Group 1
	// enums.ChaoIDStrJewelChao:            2.78, // Event (Animal Rescue event 1.0) - Group 1
	...
	// enums.ChaoIDStrRCPinwheel:           2.78, // Group 1
	enums.ChaoIDStrRCPiggyBank:          3.7, // Permanent Pool
	// enums.ChaoIDStrRCBalloon:            3.7, // Group 3
	// enums.ChaoIDStrEasterChao:           2.78, // Event (Easter; Increase Odds During Event) - Group 1
	enums.ChaoIDStrEasterBunny:          1.82, // Event (Easter; Increase Odds During Event) - Group 2
	...
	enums.ChaoIDStrEggChao:           1.82, // Permanent Pool
	enums.ChaoIDStrPumpkinChao:       1.82, // Permanent Pool
	enums.ChaoIDStrSkullChao:         1.82, // Permanent Pool
	enums.ChaoIDStrYacker:            1.82, // Permanent Pool
	enums.ChaoIDStrRCGoldenPiggyBank: 1.82, // Permanent Pool
	enums.ChaoIDStrWizardChao:        1.82, // Permanent Pool
	// enums.ChaoIDStrRCTurtle:          1.98, // Group 1
	// enums.ChaoIDStrRCUFO:             1.98, // Group 3
	enums.ChaoIDStrRCBomber:          1.82, // Group 2
	...
	enums.ChaoIDStrBlowfishTransporter:  1.82, // Event (Tropical Coast; Increase Odds During Event) - Group 2
	...
	// enums.ChaoIDStrCartridge:            1.98, // Event (Birthday; Increase Odds During Event) - Group 3
 	// enums.ChaoIDStrDeathEgg:             1.8, // Event (Birthday; Increase Odds During Event) - Group 1
	enums.ChaoIDStrRCFighter:            1.82, // Group 2
	// enums.ChaoIDStrRCHovercraft:         1.98, // Group 1
	// enums.ChaoIDStrRCHelicopter:         1.98, // Group 3
	enums.ChaoIDStrGreenCrystalMonsterS: 1.82, // Group 2
	// enums.ChaoIDStrGreenCrystalMonsterL: 1.98, // Group 1
	// enums.ChaoIDStrRCAirship:            1.98, // Group 3
	enums.ChaoIDStrMagicLamp:            4.25, // Event (Desert Ruins and Animal Rescue 2.0; Increase Odds During Event) - Group 2
	enums.ChaoIDStrDesertChao:           4.25, // Event (Desert Ruins; Increase Odds During Event) - Group 1
	...
	enums.ChaoIDStrTailsOmochao:         1.82, // Event (Team Sonic Omochao) - Group 2
	...
	enums.ChaoIDStrHalloweenChao:        1.82, // Event (Halloween; Increase Odds During Event) - Group 2
	...
	enums.ChaoIDStrOrbot:      1.82, // Group 2
